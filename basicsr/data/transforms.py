...
def Augment_with_flows(imgs, hflip=True, rotation=True, flows=None, return_status=False, vflip=False):
...
def Input_random_crop_with_grid(img_gts, img_lqs, grids, gt_patch_size, scale, gt_path):
    """Paired random crop.
    ...
    grids = [
        grid[:,top_gt:top_gt + gt_patch_size, left_gt:left_gt + gt_patch_size,:]
        for grid in grids
    ]
